...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(text_size=50, text="mountain", text_color=C_ORANGE,
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(20, MENU_OPTION[i], C_YELLOW, text_center_pos=((WIN_WIDTH / 2), 200 + 25 * i))

                else:
                    self.menu_text(20, MENU_OPTION[i], C_WHITE, text_center_pos=((WIN_WIDTH / 2), 200 + 25 * i))
